...
and a lipids-increasing gene-set with six genes: \emph{ACACA}, \emph{DGAT2}, \emph{HILPDA}, \emph{MBTPS1}, \emph{SCAP}, \emph{SRPR} (Supplementary File 1).
...
The full list of traits in each cluster is in Supplementary File 6.}\label{fig:clustering:tree}
}
\end{figure}
...
We didn't see signs of inflation when applying the method in real data (Figure \ref{fig:reg:real:qqplots}).
