...
\usepackage{lmodern}
\usepackage{iftex}
\usepackage[legalpaper, left=0.5in, right=0.5in, top=1in, bottom=1in]{geometry}
\ifPDFTeX
...
\item
  ...
  · \includesvg{images/mastodon.svg}
...
Genes work together in context-specific networks to carry out different functions {[}\protect\hyperlink{ref-e0tRKjE5}{1},\protect\hyperlink{ref-CVF61Un5}{2}{]}.
Variations in these genes can change their functional role and, at a higher level, affect disease-relevant biological processes {[}\protect\hyperlink{ref-Om8ZhS06}{3}{]}.
In this context, determining how genes influence complex traits requires mechanistically understanding expression regulation across different cell types {[}\protect\hyperlink{ref-9Pr9idng}{4},\protect\hyperlink{ref-1DoyZS7y0}{5},\protect\hyperlink{ref-nhaocxmR}{6}{]}, which in turn should lead to improved treatments {[}\protect\hyperlink{ref-REXpV7nA}{7},\protect\hyperlink{ref-PgEwSS4Q}{8}{]}.
Previous studies have described different regulatory DNA elements {[}\protect\hyperlink{ref-1DoyZS7y0}{5},\protect\hyperlink{ref-15J98V2qM}{9},\protect\hyperlink{ref-sLkFMFZj}{10},\protect\hyperlink{ref-SxuuTQTQ}{11},\protect\hyperlink{ref-xRGqPsT2}{12}{]} including genetic effects on gene expression across different tissues {[}\protect\hyperlink{ref-9Pr9idng}{4}{]}.
Integrating functional genomics data and GWAS data {[}\protect\hyperlink{ref-WFslDIWl}{13},\protect\hyperlink{ref-WFslDIWl}{13},\protect\hyperlink{ref-aIyQY5ZT}{14},\protect\hyperlink{ref-z8MQTAnJ}{15}{]} has improved the identification of these transcriptional mechanisms that, when dysregulated, commonly result in tissue- and cell lineage-specific pathology {[}\protect\hyperlink{ref-O0e3EhY6}{16},\protect\hyperlink{ref-18jYvPauB}{17},\protect\hyperlink{ref-wNE0EQlN}{18}{]}.

Given the availability of gene expression data across several tissues {[}\protect\hyperlink{ref-9Pr9idng}{4},\protect\hyperlink{ref-6SPTvFXq}{19},\protect\hyperlink{ref-Nz3IMEzd}{20},\protect\hyperlink{ref-57TjOMEA}{21}{]}, an effective approach to identify these biological processes is the transcription-wide association study (TWAS), which integrates expression quantitative trait loci (eQTLs) data to provide a mechanistic interpretation for GWAS findings.
TWAS relies on testing whether perturbations in gene regulatory mechanisms mediate the association between genetic variants and human diseases {[}\protect\hyperlink{ref-yEdRP9Xx}{22},\protect\hyperlink{ref-1D63fEEPb}{23},\protect\hyperlink{ref-1FFzCXo1s}{24},\protect\hyperlink{ref-Z8bvDdVq}{25}{]}, and these approaches have been highly successful not only in understanding disease etiology at the transcriptome level {[}\protect\hyperlink{ref-ktVcsmYD}{26},\protect\hyperlink{ref-gZAOkumx}{27},\protect\hyperlink{ref-zwpq2IXD}{28}{]} but also in disease-risk prediction (polygenic scores) {[}\protect\hyperlink{ref-hSYqogYZ}{29}{]} and drug repurposing {[}\protect\hyperlink{ref-17oeJ0CXy}{30}{]} tasks.
However, TWAS works at the individual gene level, which does not capture more complex interactions at the network level.

These gene-gene interactions play a crucial role in current theories of the architecture of complex traits, such as the omnigenic model {[}\protect\hyperlink{ref-vpIDZCSa}{31}{]}, which suggests that methods need to incorporate this complexity to disentangle disease-relevant mechanisms.
Widespread gene pleiotropy, for instance, reveals the highly interconnected nature of transcriptional networks {[}\protect\hyperlink{ref-pZZn28he}{32},\protect\hyperlink{ref-PDWEwciL}{33}{]}, where potentially all genes expressed in disease-relevant cell types have a non-zero effect on the trait {[}\protect\hyperlink{ref-vpIDZCSa}{31},\protect\hyperlink{ref-LXvTZzEA}{34}{]}.
One way to learn these gene-gene interactions is using the concept of gene module: a group of genes with similar expression profiles across different conditions {[}\protect\hyperlink{ref-CVF61Un5}{2},\protect\hyperlink{ref-jrAMOJCD}{35},\protect\hyperlink{ref-SjGoBywE}{36}{]}.
In this context, several unsupervised approaches have been proposed to infer these gene-gene connections by extracting gene modules from co-expression patterns {[}\protect\hyperlink{ref-S4e4WaP3}{37},\protect\hyperlink{ref-f2r8LLIn}{38},\protect\hyperlink{ref-VzZoy0BD}{39}{]}.
Matrix factorization techniques like independent or principal component analysis (ICA/PCA) have shown superior performance in this task {[}\protect\hyperlink{ref-1BVbSrr6M}{40}{]} since they capture local expression effects from a subset of samples and can handle modules overlap effectively.
Therefore, integrating genetic studies with gene modules extracted using unsupervised learning could further improve our understanding of disease origin {[}\protect\hyperlink{ref-SjGoBywE}{36}{]} and progression {[}\protect\hyperlink{ref-S56q1qoc}{41}{]}.
...
For this, we integrated thousands of gene-trait associations (using TWAS from PhenomeXcan {[}\protect\hyperlink{ref-lY5ln3dB}{42}{]}) and transcriptional profiles of drugs (from LINCS L1000 {[}\protect\hyperlink{ref-F7lIlh2N}{43}{]}) into a low-dimensional space learned from public gene expression data on tens of thousands of RNA-seq samples (recount2 {[}\protect\hyperlink{ref-6SPTvFXq}{19},\protect\hyperlink{ref-14rnBunuZ}{44}{]}).
We used a latent representation defined by a matrix factorization approach {[}\protect\hyperlink{ref-14rnBunuZ}{44},\protect\hyperlink{ref-Ki2ij7zE}{45}{]} that extracts gene modules with certain sparsity constraints and preferences for those that align with prior knowledge (pathways).
...
We observed that significant module-trait associations in PhenomeXcan (our discovery cohort) replicated in the Electronic Medical Records and Genomics (eMERGE) network phase III {[}\protect\hyperlink{ref-gZAOkumx}{27},\protect\hyperlink{ref-wfqjCerX}{46}{]} (our replication cohort).
...
\centering
\includesvg[width=1\textwidth,height=\textheight]{images/entire_process/entire_process.svg}
...
Since LVs might represent a functional set of genes regulated by the same transcriptional program {[}\protect\hyperlink{ref-1FVd2WW6G}{48},\protect\hyperlink{ref-DN7TyZzb}{49}{]}, we conjecture that the projection of TWAS and pharmacologic perturbations data into this latent space could provide a better mechanistic understanding.
...
In the original MultiPLIER study, the authors reported that one of the latent variables, identified as LV603, was associated with a known neutrophil pathway and highly correlated with neutrophil count estimates from whole blood RNA-seq profiles {[}\protect\hyperlink{ref-18TSqd1tG}{50}{]}.
...
Are these cell type-specific modules associated with \emph{different} diseases, thus potentially representing a ``network pleiotropy'' example from an omnigenic point of view {[}\protect\hyperlink{ref-vpIDZCSa}{31}{]}?
Is there a subset of module's genes that is closer to the definition of ``core'' genes (i.e., directly affecting the trait with no mediated regulation of other genes {[}\protect\hyperlink{ref-LXvTZzEA}{34}{]}) and thus represents alternative and potentially better candidate targets?
...
\textbf{b)} Gene-trait associations (S-MultiXcan; threshold at -log(\(p\))=10) and colocalization probability (fastENLOC) for the top traits in LV246.
...
Next, we analyzed all 987 LVs using Fast Gene Set Enrichment Analysis (FGSEA) {[}\protect\hyperlink{ref-Z8WXLD67}{51}{]}, and found 15 LVs nominally enriched (unadjusted \emph{P} \textless{} 0.01) with these lipid-altering gene-sets (Supplementary Tables \ref{tbl:sup:lipids_crispr:modules_enriched_increase} and \ref{tbl:sup:lipids_crispr:modules_enriched_decrease}).
...
This lack of association of two high-confidence genes from our CRISPR screen might be explained from an omnigenic point of view {[}\protect\hyperlink{ref-LXvTZzEA}{34}{]}.
...
For this, we used the transcriptional responses to small molecule perturbations profiled in LINCS L1000 {[}\protect\hyperlink{ref-F7lIlh2N}{43}{]}, which were further processed and mapped to DrugBank IDs {[}\protect\hyperlink{ref-6PR8LEXK}{52},\protect\hyperlink{ref-O21tn8vf}{53},\protect\hyperlink{ref-1DJZvtwP1}{54}{]}.
Based on an established drug repurposing strategy that matches reversed transcriptome patterns between genes and drug-induced perturbations {[}\protect\hyperlink{ref-1ClBKizD7}{55},\protect\hyperlink{ref-mZjkE1xU}{56}{]}, we adopted a previously described framework that uses imputed transcriptomes from TWAS to prioritize drug candidates {[}\protect\hyperlink{ref-17oeJ0CXy}{30}{]}.
...
We used a manually-curated gold standard set of drug-disease medical indications {[}\protect\hyperlink{ref-O21tn8vf}{53},\protect\hyperlink{ref-10KA5jTBQ}{57}{]} for 322 drugs across 53 diseases to evaluate the prediction performance.
...
Nicotinic acid (niacin) is a B vitamin widely used clinically to treat lipid disorders, although there is controversy on its clinical utility in preventing cardiovascular disease {[}\protect\hyperlink{ref-bRPc66OD}{58},\protect\hyperlink{ref-13ZGxHjQ5}{59},\protect\hyperlink{ref-ZGvG75Bj}{60}{]}.
Niacin exerts its effects on multiple tissues, although its mechanisms are not well understood {[}\protect\hyperlink{ref-LVihFr3g}{61},\protect\hyperlink{ref-7OgaYjeL}{62},\protect\hyperlink{ref-OOAkmacQ}{63},\protect\hyperlink{ref-13meq3Hgt}{64}{]}.
This compound can increase high-density lipoprotein (HDL) by inhibiting an HDL catabolism receptor in the liver.
Niacin also inhibits diacylglycerol acyltransferase--2 (DGAT2), which decreases the production of low-density lipoproteins (LDL) either by modulating triglyceride synthesis in hepatocytes or by inhibiting adipocyte triglyceride lipolysis {[}\protect\hyperlink{ref-LVihFr3g}{61}{]}.
...
For example, \emph{GPR109A/HCAR2} encodes a G protein-coupled high-affinity niacin receptor in adipocytes and immune cells, including monocytes, macrophages, neutrophils and dendritic cells {[}\protect\hyperlink{ref-izbPw2kc}{65},\protect\hyperlink{ref-wI0IjT3i}{66}{]}.
...
However, it has been shown that nicotinic acid can reduce atherosclerosis progression independently of its antidyslipidemic activity by activating \emph{GPR109A} in immune cells {[}\protect\hyperlink{ref-1Bz0jRHYo}{67}{]}, thus boosting anti-inflammatory processes {[}\protect\hyperlink{ref-1DblG8swn}{68}{]}.
...
In Figure \ref{fig:lv116:cell_types}, it can be seen that LV116's genes are expressed as an immune response when these cell types are under different stimuli, such as diarrhea caused by different pathogens {[}\protect\hyperlink{ref-RliFvowC}{69}{]}, samples from multiple sclerosis or systemic lupus erythematosus {[}\protect\hyperlink{ref-D5XBhzim}{70},\protect\hyperlink{ref-EnoqU4ga}{71}{]}, or infected with different viruses (such as herpes simplex {[}\protect\hyperlink{ref-11eausmiy}{72}{]}, West Nile virus {[}\protect\hyperlink{ref-mtMYROCN}{73}{]}, \emph{Salmonella typhimurium} {[}\protect\hyperlink{ref-1kgcHkGm}{74}{]}, among others).
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0921}}
...
This compound has been very recently considered a potential therapeutic for ovarian diseases {[}\protect\hyperlink{ref-kLRErKXz}{75},\protect\hyperlink{ref-TovvsrDr}{76}{]}, as it was found to promote follicle growth and inhibit granulosa cell apoptosis in animal models.
...
Consensus or ensemble approaches have been recommended to avoid several pitfalls when performing cluster analysis on biological data {[}\protect\hyperlink{ref-14dCeRkua}{77}{]}.
...
Then, a consensus function combines the ensemble into a consolidated solution, which has been shown to outperform any individual member of the ensemble {[}\protect\hyperlink{ref-uw3AnEgA}{78},\protect\hyperlink{ref-cuROQDFa}{79}{]}.
...
The number of clusters of these partitions (between 5 to 29) was learned from the data by selecting the partitions with the largest agreement with the ensemble {[}\protect\hyperlink{ref-uw3AnEgA}{78}{]}.
Instead of selecting one of these final solutions with a specific number of clusters, we used a clustering tree {[}\protect\hyperlink{ref-xhtEAzx6}{80}{]} (Figure \ref{fig:clustering:tree}) to examine stable groups of traits across multiple resolutions.
...
\emph{Descriptions of traits by cluster ID (from left to right):}
...
3: includes eosinophil count, eosinophil percentage, and eosinophil+basophil count.}\label{fig:clustering:tree}
}
\end{figure}
...
LV136, aligned with known collagen formation and muscle contraction pathways (Supplementary Table \ref{tbl:sup:multiplier_pathways:lv136}), was associated with coronary artery disease and keratometry measurements in PhenomeXcan (Supplementary Tables \ref{tbl:sup:phenomexcan_assocs:lv136}).
...
These disorders were previously linked to the cardiovascular system {[}\protect\hyperlink{ref-10qjLoufR}{83},\protect\hyperlink{ref-j2Sl4DAE}{84},\protect\hyperlink{ref-17LYMnG9n}{85},\protect\hyperlink{ref-13t4TuFeJ}{86}{]} and share several risk factors, including hypertension, high cholesterol, obesity, smoking, among others {[}\protect\hyperlink{ref-D83Aqhga}{87},\protect\hyperlink{ref-9BGyO071}{88}{]}.
...
As discussed previously, macrophages play a key role in the reverse cholesterol transport and thus atherogenesis {[}\protect\hyperlink{ref-idlBgtFz}{89}{]}, and lipid metabolism in microglia has been recently identified as an important factor in the development of neurodegenerative diseases {[}\protect\hyperlink{ref-18I4ish9s}{90}{]}.
...
Considering groups of related diseases was previously shown to be more powerful in detecting shared genetic etiology {[}\protect\hyperlink{ref-LyJmyoQr}{91},\protect\hyperlink{ref-veADXImD}{92}{]}, and clustering trees provide a way to explore such relationships in the context of latent variables.
...
In addition, recount2, the training dataset used, has since been surpassed in size and scale by other resources {[}\protect\hyperlink{ref-Nz3IMEzd}{20},\protect\hyperlink{ref-TPVeG4GP}{93}{]}.
However, it is important to note that our models impose very few assumptions on the latent expression representation.
Therefore, we should be able to easily replace MultiPLIER with other similar approaches like GenomicSuperSignature {[}\protect\hyperlink{ref-X4fhSCkz}{94}{]}.
...
Additionally, TWAS has several limitations that can lead to false positives {[}\protect\hyperlink{ref-l6ogswV3}{95},\protect\hyperlink{ref-ndd3tW4g}{96}{]}.
Like GWAS, which generally detects groups of associated variants in linkage disequilibrium (LD), TWAS usually identifies several genes within the same locus {[}\protect\hyperlink{ref-Z8bvDdVq}{25},\protect\hyperlink{ref-AxVJwanp}{97}{]}.
This is due to sharing of GWAS variants in gene expression models, correlated expression of nearby genes, or even correlation of their predicted expression due to eQTLs in LD, among others {[}\protect\hyperlink{ref-l6ogswV3}{95}{]}.
Our LV-based regression framework, however, accounts for these gene-gene correlations in TWAS reasonably well.

Our findings are concordant with previous studies showing that drugs with genetic support are more likely to succeed through the drug development pipeline {[}\protect\hyperlink{ref-REXpV7nA}{7},\protect\hyperlink{ref-17oeJ0CXy}{30}{]}.
...
New approaches to infer and annotate with structured metadata are promising and can be directly applied to existing data {[}\protect\hyperlink{ref-fnDaLjFy}{98}{]}.
...
\subsection{Methods and materials}\label{sec:methods}}
...
We used Summary-PrediXcan (S-PrediXcan) {[}\protect\hyperlink{ref-vLyTudUB}{99}{]} and Summary-MultiXcan (S-MultiXcan) {[}\protect\hyperlink{ref-1FFzCXo1s}{24}{]} as the gene-based statistical approaches, which belong to the PrediXcan family of methods {[}\protect\hyperlink{ref-Z8bvDdVq}{25}{]}.
...
S-PrediXcan {[}\protect\hyperlink{ref-vLyTudUB}{99}{]} is the summary version of PrediXcan {[}\protect\hyperlink{ref-Z8bvDdVq}{25}{]}.
...
In these TWAS methods, the genotype variances and covariances are always estimated using the Genotype-Tissue Expression project (GTEx v8) {[}\protect\hyperlink{ref-9Pr9idng}{4}{]} as the reference panel.
...
S-MultiXcan {[}\protect\hyperlink{ref-1FFzCXo1s}{24}{]}, on the other hand, is the summary version of MultiXcan.
...
where \(\mathbf{\hat{z}}\) is a vector with \(p\) \(z\)-scores (Equation (\ref{eq:spredixcan})) for each tissue available for the gene,
...
Although S-MultiXcan yields highly concordant estimates compared with MultiXcan, results are not perfectly correlated across genes {[}\protect\hyperlink{ref-1FFzCXo1s}{24}{]}.
...
PhenomeXcan {[}\protect\hyperlink{ref-lY5ln3dB}{42}{]}, our discovery cohort, provides results on 4,091 traits across different categories.
...
2) a posterior probability of colocalization between GWAS loci and \emph{cis}-eQTL with fastENLOC {[}\protect\hyperlink{ref-lY5ln3dB}{42},\protect\hyperlink{ref-ndd3tW4g}{96}{]}.
...
Our discovery cohort was eMERGE {[}\protect\hyperlink{ref-wfqjCerX}{46}{]}, where the same TWAS methods were run on 309 phecodes {[}\protect\hyperlink{ref-gZAOkumx}{27}{]} across different categories (more information about traits are available in {[}\protect\hyperlink{ref-gZAOkumx}{27}{]}).
...
MultiPLIER {[}\protect\hyperlink{ref-14rnBunuZ}{44}{]} extracts patterns of co-expressed genes from recount2 {[}\protect\hyperlink{ref-6SPTvFXq}{19}{]} (without including GTEx samples), a large gene expression dataset.
The approach applies the pathway-level information extractor method (PLIER) {[}\protect\hyperlink{ref-Ki2ij7zE}{45}{]}, which performs unsupervised learning using prior knowledge (canonical pathways) to reduce technical noise.
...
Given a gene expression dataset \(\mathbf{Y}^{m \times c}\) with \(m\) genes and \(c\) experimental conditions and a prior knowledge matrix \(\mathbf{C} \in \{0,1\}^{m \times p}\) for \(p\) MSigDB pathways {[}\protect\hyperlink{ref-1CbVoEpNJ}{100}{]} (so that \(\mathbf{C}_{ij} = 1\) if gene \(i\) belongs to pathway \(j\)), PLIER finds \(\mathbf{U}\), \(\mathbf{Z}\), and \(\mathbf{B}\) minimizing
...
We adapted the gene-set analysis framework from MAGMA {[}\protect\hyperlink{ref-19XiXgYmd}{101}{]} to TWAS.
...
In the PrediXcan family of methods, the predicted expression of a pair of genes could be correlated if they share eQTLs or if these are in LD {[}\protect\hyperlink{ref-l6ogswV3}{95}{]}.
...
\end{split}
\label{eq:reg:corpp}\end{equation}
...
Cell images were captured through fluorescent microscope EVOS for GFP signal detection (Figure \ref{fig:sup:crispr:fig1}).
...
\textasciitilde20\% of each GFP-High and GFP-Low (Figure \ref{fig:sup:crispr:fig2}) were collected into 15ml tubes.
...
sgRNA cassette and lentiviral specific transgene in isolated gDNA were verified through PCR (Figure \ref{fig:sup:crispr:fig3}).

\textbf{Illumina libraries generation and sequencing.}
The fragment containing sgRNA cassette was amplified using P5 /P7 primers, as indicated in {[}\protect\hyperlink{ref-vNXTnmxp}{115}{]}, and primer sequences were adapted from Broad Institute protocol (Figure \ref{fig:sup:crispr:table1}).
...
\subsubsection{Code and data availability}\label{code-and-data-availability}}

The code and data to reproduce all the analyses in this work are available in \url{https://github.com/greenelab/phenoplier}.
...
\CSLLeftMargin{1. }%
\CSLRightInline{\textbf{A large-scale analysis of tissue-specific pathology and gene expression of human disease genes and complexes.}
\CSLBlock{Kasper Lage, Niclas Tue Hansen, EOlof Karlberg, Aron C Eklund, Francisco S Roque, Patricia K Donahoe, Zoltan Szallasi, Thomas Skøt Jensen, Søren Brunak} \emph{Proceedings of the National Academy of Sciences of the United States of America} (2008-12-22) \url{https://www.ncbi.nlm.nih.gov/pubmed/19104045}
\CSLBlock{DOI: \href{https://doi.org/10.1073/pnas.0810772105}{10.1073/pnas.0810772105} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/19104045}{19104045} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2606902}{PMC2606902}}}

\leavevmode\vadjust pre{\hypertarget{ref-CVF61Un5}{}}%
\CSLLeftMargin{2. }%
\CSLRightInline{\textbf{Understanding multicellular function and disease with human tissue-specific networks}
\CSLBlock{Casey S Greene, Arjun Krishnan, Aaron K Wong, Emanuela Ricciotti, Rene A Zelaya, Daniel S Himmelstein, Ran Zhang, Boris M Hartmann, Elena Zaslavsky, Stuart C Sealfon, \ldots{} Olga G Troyanskaya} \emph{Nature Genetics} (2015-04-27) \url{https://doi.org/f7dvkv}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ng.3259}{10.1038/ng.3259} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25915600}{25915600} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4828725}{PMC4828725}}}
...
\CSLLeftMargin{5. }%
\CSLRightInline{\textbf{Index and biological spectrum of human DNase I hypersensitive sites}
\CSLBlock{Wouter Meuleman, Alexander Muratov, Eric Rynes, Jessica Halow, Kristen Lee, Daniel Bates, Morgan Diegel, Douglas Dunn, Fidencio Neri, Athanasios Teodosiadis, \ldots{} John Stamatoyannopoulos} \emph{Nature} (2020-07-29) \url{https://doi.org/gg6dhp}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41586-020-2559-3}{10.1038/s41586-020-2559-3} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32728217}{32728217} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7422677}{PMC7422677}}}

\leavevmode\vadjust pre{\hypertarget{ref-nhaocxmR}{}}%
\CSLLeftMargin{6. }%
\CSLRightInline{\textbf{Mechanisms of tissue and cell-type specificity in heritable traits and~diseases}
\CSLBlock{Idan Hekselman, Esti Yeger-Lotem} \emph{Nature Reviews Genetics} (2020-01-08) \url{https://doi.org/ggkx9v}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41576-019-0200-9}{10.1038/s41576-019-0200-9} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/31913361}{31913361}}}

\leavevmode\vadjust pre{\hypertarget{ref-REXpV7nA}{}}%
\CSLLeftMargin{7. }%
\CSLRightInline{\textbf{The support of human genetic evidence for approved drug indications}
\CSLBlock{Matthew R Nelson, Hannah Tipney, Jeffery L Painter, Judong Shen, Paola Nicoletti, Yufeng Shen, Aris Floratos, Pak Chung Sham, Mulin Jun Li, Junwen Wang, \ldots{} Philippe Sanseau} \emph{Nature Genetics} (2015-06-29) \url{https://doi.org/f3mn52}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ng.3314}{10.1038/ng.3314} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/26121088}{26121088}}}

\leavevmode\vadjust pre{\hypertarget{ref-PgEwSS4Q}{}}%
\CSLLeftMargin{8. }%
\CSLRightInline{\textbf{Are drug targets with genetic support twice as likely to be approved? Revised estimates of the impact of genetic support for drug mechanisms on the probability of drug approval}
\CSLBlock{Emily A King, JWade Davis, Jacob F Degner} \emph{PLOS Genetics} (2019-12-12) \url{https://doi.org/gg957r}
\CSLBlock{DOI: \href{https://doi.org/10.1371/journal.pgen.1008489}{10.1371/journal.pgen.1008489} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/31830040}{31830040} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6907751}{PMC6907751}}}

\leavevmode\vadjust pre{\hypertarget{ref-15J98V2qM}{}}%
\CSLLeftMargin{9. }%
\CSLRightInline{\textbf{An integrated encyclopedia of DNA elements in the human genome} \emph{Nature} (2012-09) \url{https://doi.org/bg9d}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nature11247}{10.1038/nature11247} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/22955616}{22955616} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3439153}{PMC3439153}}}

\leavevmode\vadjust pre{\hypertarget{ref-sLkFMFZj}{}}%
\CSLLeftMargin{10. }%
\CSLRightInline{\textbf{Integrative analysis of 111 reference human epigenomes}
\CSLBlock{Anshul Kundaje, Wouter Meuleman, Jason Ernst, Misha Bilenky, Angela Yen, Alireza Heravi-Moussavi, Pouya Kheradpour, Zhizhuo Zhang, Jianrong Wang, \ldots{} Manolis Kellis} \emph{Nature} (2015-02-18) \url{https://doi.org/f62jpn}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nature14248}{10.1038/nature14248} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25693563}{25693563} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4530010}{PMC4530010}}}

\leavevmode\vadjust pre{\hypertarget{ref-SxuuTQTQ}{}}%
\CSLLeftMargin{11. }%
\CSLRightInline{\textbf{An atlas of active enhancers across human cell types and tissues}
\CSLBlock{Robin Andersson, Claudia Gebhard, Irene Miguel-Escalada, Ilka Hoof, Jette Bornholdt, Mette Boyd, Yun Chen, Xiaobei Zhao, Christian Schmidl, \ldots{} Albin Sandelin} \emph{Nature} (2014-03) \url{https://doi.org/r35}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nature12787}{10.1038/nature12787} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24670763}{24670763} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5215096}{PMC5215096}}}

\leavevmode\vadjust pre{\hypertarget{ref-xRGqPsT2}{}}%
\CSLLeftMargin{12. }%
\CSLRightInline{\textbf{Regulatory genomic circuitry of human disease loci by integrative epigenomics}
\CSLBlock{Carles A Boix, Benjamin T James, Yongjin P Park, Wouter Meuleman, Manolis Kellis} \emph{Nature} (2021-02-03) \url{https://doi.org/ghzkhr}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41586-020-03145-z}{10.1038/s41586-020-03145-z} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/33536621}{33536621} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7875769}{PMC7875769}}}

\leavevmode\vadjust pre{\hypertarget{ref-WFslDIWl}{}}%
\CSLLeftMargin{13. }%
\CSLRightInline{\textbf{Heritability enrichment of specifically expressed genes identifies disease-relevant tissues and cell types}
\CSLBlock{Hilary K Finucane, Yakir A Reshef, Verneri Anttila, Kamil Slowikowski, Alexander Gusev, Andrea Byrnes, Steven Gazal, Po-Ru Loh, Caleb Lareau, Noam Shoresh, \ldots{} } \emph{Nature Genetics} (2018-04) \url{https://doi.org/gdfjqt}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41588-018-0081-4}{10.1038/s41588-018-0081-4} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29632380}{29632380} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5896795}{PMC5896795}}}

\leavevmode\vadjust pre{\hypertarget{ref-aIyQY5ZT}{}}%
\CSLLeftMargin{14. }%
\CSLRightInline{\textbf{The Post-GWAS Era: From Association to Function}
\CSLBlock{Michael D Gallagher, Alice S Chen-Plotkin} \emph{The American Journal of Human Genetics} (2018-05) \url{https://doi.org/gdmftd}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.ajhg.2018.04.002}{10.1016/j.ajhg.2018.04.002} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29727686}{29727686} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5986732}{PMC5986732}}}

\leavevmode\vadjust pre{\hypertarget{ref-z8MQTAnJ}{}}%
\CSLLeftMargin{15. }%
\CSLRightInline{\textbf{Biological interpretation of genome-wide association studies using predicted gene functions}
\CSLBlock{Tune H Pers, Juha M Karjalainen, Yingleong Chan, Harm-Jan Westra, Andrew R Wood, Jian Yang, Julian C Lui, Sailaja Vedantam, Stefan Gustafsson, \ldots{} Lude Franke} \emph{Nature Communications} (2015-01-19) \url{https://doi.org/f3mwhd}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ncomms6890}{10.1038/ncomms6890} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25597830}{25597830} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4420238}{PMC4420238}}}

\leavevmode\vadjust pre{\hypertarget{ref-O0e3EhY6}{}}%
\CSLLeftMargin{16. }%
\CSLRightInline{\textbf{Relaxed purifying selection and possibly high rate of adaptation in primate lineage-specific genes.}
\CSLBlock{James J Cai, Dmitri A Petrov} \emph{Genome biology and evolution} (2010-07-12) \url{https://www.ncbi.nlm.nih.gov/pubmed/20624743}
\CSLBlock{DOI: \href{https://doi.org/10.1093/gbe/evq019}{10.1093/gbe/evq019} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/20624743}{20624743} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2997544}{PMC2997544}}}

\leavevmode\vadjust pre{\hypertarget{ref-18jYvPauB}{}}%
\CSLLeftMargin{17. }%
\CSLRightInline{\textbf{Elevated rates of protein secretion, evolution, and disease among tissue-specific genes.}
\CSLBlock{Eitan E Winter, Leo Goodstadt, Chris P Ponting} \emph{Genome research} (2004-01) \url{https://www.ncbi.nlm.nih.gov/pubmed/14707169}
\CSLBlock{DOI: \href{https://doi.org/10.1101/gr.1924004}{10.1101/gr.1924004} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/14707169}{14707169} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC314278}{PMC314278}}}

\leavevmode\vadjust pre{\hypertarget{ref-wNE0EQlN}{}}%
\CSLLeftMargin{18. }%
\CSLRightInline{\textbf{A large-scale analysis of tissue-specific pathology and gene expression of human disease genes and complexes}
\CSLBlock{Kasper Lage, Niclas Tue Hansen, EOlof Karlberg, Aron C Eklund, Francisco S Roque, Patricia K Donahoe, Zoltan Szallasi, Thomas Skøt Jensen, Søren Brunak} \emph{Proceedings of the National Academy of Sciences} (2008-12-30) \url{https://doi.org/d5qcv9}
\CSLBlock{DOI: \href{https://doi.org/10.1073/pnas.0810772105}{10.1073/pnas.0810772105} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/19104045}{19104045} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2606902}{PMC2606902}}}
...
\CSLLeftMargin{20. }%
\CSLRightInline{\textbf{Massive mining of publicly available RNA-seq data from human and mouse}
\CSLBlock{Alexander Lachmann, Denis Torre, Alexandra B Keenan, Kathleen M Jagodnik, Hoyjin J Lee, Lily Wang, Moshe C Silverstein, Avi Ma'ayan} \emph{Nature Communications} (2018-04-10) \url{https://doi.org/gc92dr}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41467-018-03751-6}{10.1038/s41467-018-03751-6} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29636450}{29636450} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5893633}{PMC5893633}}}

\leavevmode\vadjust pre{\hypertarget{ref-57TjOMEA}{}}%
\CSLLeftMargin{21. }%
\CSLRightInline{\textbf{Identification of therapeutic targets from genetic association studies using hierarchical component analysis}
\CSLBlock{Hao-Chih Lee, Osamu Ichikawa, Benjamin S Glicksberg, Aparna A Divaraniya, Christine E Becker, Pankaj Agarwal, Joel T Dudley} \emph{BioData Mining} (2020-06-17) \url{https://doi.org/gjp5pf}
\CSLBlock{DOI: \href{https://doi.org/10.1186/s13040-020-00216-9}{10.1186/s13040-020-00216-9} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32565911}{32565911} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7301559}{PMC7301559}}}

\leavevmode\vadjust pre{\hypertarget{ref-yEdRP9Xx}{}}%
\CSLLeftMargin{22. }%
\CSLRightInline{\textbf{Novel Variance-Component TWAS method for studying complex human diseases with applications to Alzheimer's dementia}
\CSLBlock{Shizhen Tang, Aron S Buchman, Philip L De Jager, David A Bennett, Michael P Epstein, Jingjing Yang} \emph{PLOS Genetics} (2021-04-02) \url{https://doi.org/gjpr3j}
\CSLBlock{DOI: \href{https://doi.org/10.1371/journal.pgen.1009482}{10.1371/journal.pgen.1009482} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/33798195}{33798195} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8046351}{PMC8046351}}}
...
\CSLBlock{Eric R Gamazon, Heather E Wheeler, Kaanan P Shah, Sahar V Mozaffari, Keston Aquino-Michaels, Robert J Carroll, Anne E Eyler, Joshua C Denny, Dan L Nicolae, Nancy J Cox, \ldots{} } \emph{Nature Genetics} (2015-08-10) \url{https://doi.org/f7p9zv}
...
\CSLLeftMargin{26. }%
\CSLRightInline{\textbf{UTMOST, a single and cross-tissue TWAS (Transcriptome Wide Association Study), reveals new ASD (Autism Spectrum Disorder) associated genes.}
\CSLBlock{Cristina Rodriguez-Fontenla, Angel Carracedo} \emph{Translational psychiatry} (2021-04-30) \url{https://www.ncbi.nlm.nih.gov/pubmed/33931583}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41398-021-01378-8}{10.1038/s41398-021-01378-8} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/33931583}{33931583} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8087708}{PMC8087708}}}
...
\CSLLeftMargin{28. }%
\CSLRightInline{\textbf{Shared and distinct genetic risk factors for childhood-onset and adult-onset asthma: genome-wide and transcriptome-wide studies.}
\CSLBlock{Milton Pividori, Nathan Schoettler, Dan L Nicolae, Carole Ober, Hae Kyung Im} \emph{The Lancet. Respiratory medicine} (2019-04-27) \url{https://www.ncbi.nlm.nih.gov/pubmed/31036433}
\CSLBlock{DOI: \href{https://doi.org/10.1016/s2213-2600(19)30055-4}{10.1016/s2213-2600(19)30055-4} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/31036433}{31036433} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6534440}{PMC6534440}}}

\leavevmode\vadjust pre{\hypertarget{ref-hSYqogYZ}{}}%
\CSLLeftMargin{29. }%
\CSLRightInline{\textbf{Polygenic transcriptome risk scores (PTRS) can improve portability of polygenic risk scores across ancestries}
\CSLBlock{Yanyu Liang, Milton Pividori, Ani Manichaikul, Abraham A Palmer, Nancy J Cox, Heather E Wheeler, Hae Kyung Im} \emph{Genome Biology} (2022-01-13) \url{https://doi.org/gqtdvn}
\CSLBlock{DOI: \href{https://doi.org/10.1186/s13059-021-02591-w}{10.1186/s13059-021-02591-w} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/35027082}{35027082} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8759285}{PMC8759285}}}
...
\CSLLeftMargin{32. }%
\CSLRightInline{\textbf{A global overview of pleiotropy and genetic architecture in complex traits}
\CSLBlock{Kyoko Watanabe, Sven Stringer, Oleksandr Frei, Maša Umićević Mirkov, Christiaan de Leeuw, Tinca JC Polderman, Sophie van der Sluis, Ole A Andreassen, Benjamin M Neale, Danielle Posthuma} \emph{Nature Genetics} (2019-08-19) \url{https://doi.org/ggr84r}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41588-019-0481-0}{10.1038/s41588-019-0481-0} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/31427789}{31427789}}}

\leavevmode\vadjust pre{\hypertarget{ref-PDWEwciL}{}}%
\CSLLeftMargin{33. }%
\CSLRightInline{\textbf{Detection and interpretation of shared genetic influences on 42 human traits}
\CSLBlock{Joseph K Pickrell, Tomaz Berisa, Jimmy Z Liu, Laure Ségurel, Joyce Y Tung, David A Hinds} \emph{Nature Genetics} (2016-05-16) \url{https://doi.org/f8ssw4}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ng.3570}{10.1038/ng.3570} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/27182965}{27182965} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5207801}{PMC5207801}}}
...
\CSLLeftMargin{35. }%
\CSLRightInline{\textbf{Architecture of the human regulatory network derived from ENCODE data.}
\CSLBlock{Mark B Gerstein, Anshul Kundaje, Manoj Hariharan, Stephen G Landt, Koon-Kiu Yan, Chao Cheng, Xinmeng Jasmine Mu, Ekta Khurana, Joel Rozowsky, Roger Alexander, \ldots{} Michael Snyder} \emph{Nature} (2012-09-06) \url{https://www.ncbi.nlm.nih.gov/pubmed/22955619}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nature11245}{10.1038/nature11245} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/22955619}{22955619} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4154057}{PMC4154057}}}

\leavevmode\vadjust pre{\hypertarget{ref-SjGoBywE}{}}%
\CSLLeftMargin{36. }%
\CSLRightInline{\textbf{A narrow repertoire of transcriptional modules responsive to pyogenic bacteria is impaired in patients carrying loss-of-function mutations in MYD88 or IRAK4.}
\CSLBlock{Laia Alsina, Elisabeth Israelsson, Matthew C Altman, Kristen K Dang, Pegah Ghandil, Laura Israel, Horst von Bernuth, Nicole Baldwin, Huanying Qin, Zongbo Jin, \ldots{} Damien Chaussabel} \emph{Nature immunology} (2014-10-26) \url{https://www.ncbi.nlm.nih.gov/pubmed/25344726}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ni.3028}{10.1038/ni.3028} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25344726}{25344726} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4281021}{PMC4281021}}}

\leavevmode\vadjust pre{\hypertarget{ref-S4e4WaP3}{}}%
\CSLLeftMargin{37. }%
\CSLRightInline{\textbf{Cluster analysis and display of genome-wide expression patterns.}
\CSLBlock{MB Eisen, PT Spellman, PO Brown, D Botstein} \emph{Proceedings of the National Academy of Sciences of the United States of America} (1998-12-08) \url{https://www.ncbi.nlm.nih.gov/pubmed/9843981}
\CSLBlock{DOI: \href{https://doi.org/10.1073/pnas.95.25.14863}{10.1073/pnas.95.25.14863} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/9843981}{9843981} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC24541}{PMC24541}}}

\leavevmode\vadjust pre{\hypertarget{ref-f2r8LLIn}{}}%
\CSLLeftMargin{38. }%
\CSLRightInline{\textbf{Democratizing systems immunology with modular transcriptional repertoire analyses.}
\CSLBlock{Damien Chaussabel, Nicole Baldwin} \emph{Nature reviews. Immunology} (2014-04) \url{https://www.ncbi.nlm.nih.gov/pubmed/24662387}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nri3642}{10.1038/nri3642} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24662387}{24662387} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4118927}{PMC4118927}}}

\leavevmode\vadjust pre{\hypertarget{ref-VzZoy0BD}{}}%
\CSLLeftMargin{39. }%
\CSLRightInline{\textbf{How does gene expression clustering work?}
\CSLBlock{Patrik D\textquotesingle haeseleer} \emph{Nature biotechnology} (2005-12) \url{https://www.ncbi.nlm.nih.gov/pubmed/16333293}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nbt1205-1499}{10.1038/nbt1205-1499} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/16333293}{16333293}}}
...
\CSLLeftMargin{41. }%
\CSLRightInline{\textbf{A modular analysis framework for blood genomics studies: application to systemic lupus erythematosus.}
\CSLBlock{Damien Chaussabel, Charles Quinn, Jing Shen, Pinakeen Patel, Casey Glaser, Nicole Baldwin, Dorothee Stichweh, Derek Blankenship, Lei Li, Indira Munagala, \ldots{} Virginia Pascual} \emph{Immunity} (2008-07-18) \url{https://www.ncbi.nlm.nih.gov/pubmed/18631455}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.immuni.2008.05.012}{10.1016/j.immuni.2008.05.012} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/18631455}{18631455} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2727981}{PMC2727981}}}
...
\CSLBlock{DOI: \href{https://doi.org/10.1126/sciadv.aba2083}{10.1126/sciadv.aba2083} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32917697}{32917697}}}
...
\CSLLeftMargin{48. }%
\CSLRightInline{\textbf{Finding function: evaluation methods for functional genomic data}
\CSLBlock{Chad L Myers, Daniel R Barrett, Matthew A Hibbs, Curtis Huttenhower, Olga G Troyanskaya} \emph{BMC Genomics} (2006-07-25) \url{https://doi.org/fg6wnk}
\CSLBlock{DOI: \href{https://doi.org/10.1186/1471-2164-7-187}{10.1186/1471-2164-7-187} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/16869964}{16869964} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1560386}{PMC1560386}}}

\leavevmode\vadjust pre{\hypertarget{ref-DN7TyZzb}{}}%
\CSLLeftMargin{49. }%
\CSLRightInline{\textbf{The CAFA challenge reports improved protein function prediction and new functional annotations for hundreds of genes through experimental screens}
\CSLBlock{Naihui Zhou, Yuxiang Jiang, Timothy R Bergquist, Alexandra J Lee, Balint Z Kacsoh, Alex W Crocker, Kimberley A Lewis, George Georghiou, Huy N Nguyen, Md Nafiz Hamid, \ldots{} Iddo Friedberg} \emph{Genome Biology} (2019-11-19) \url{https://doi.org/ggnxpz}
\CSLBlock{DOI: \href{https://doi.org/10.1186/s13059-019-1835-8}{10.1186/s13059-019-1835-8} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/31744546}{31744546} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6864930}{PMC6864930}}}

\leavevmode\vadjust pre{\hypertarget{ref-18TSqd1tG}{}}%
\CSLLeftMargin{50. }%
\CSLRightInline{\textbf{Estimating the~population abundance of tissue-infiltrating immune and stromal cell populations using gene expression}
\CSLBlock{Etienne Becht, Nicolas A Giraldo, Laetitia Lacroix, Bénédicte Buttard, Nabila Elarouci, Florent Petitprez, Janick Selves, Pierre Laurent-Puig, Catherine Sautès-Fridman, Wolf H Fridman, Aurélien de Reyniès} \emph{Genome Biology} (2016-10-20) \url{https://doi.org/f87sgf}
\CSLBlock{DOI: \href{https://doi.org/10.1186/s13059-016-1070-5}{10.1186/s13059-016-1070-5} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/27765066}{27765066} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5073889}{PMC5073889}}}

\leavevmode\vadjust pre{\hypertarget{ref-Z8WXLD67}{}}%
\CSLLeftMargin{51. }%
\CSLRightInline{\textbf{Fast gene set enrichment analysis}
\CSLBlock{Gennady Korotkevich, Vladimir Sukhov, Nikolay Budin, Boris Shpak, Maxim N Artyomov, Alexey Sergushichev} \emph{Cold Spring Harbor Laboratory} (2016-06-20) \url{https://doi.org/gfpqhm}
\CSLBlock{DOI: \href{https://doi.org/10.1101/060012}{10.1101/060012}}}

\leavevmode\vadjust pre{\hypertarget{ref-6PR8LEXK}{}}%
\CSLLeftMargin{52. }%
\CSLRightInline{\textbf{DrugBank 4.0: shedding new light on drug metabolism}
\CSLBlock{Vivian Law, Craig Knox, Yannick Djoumbou, Tim Jewison, An Chi Guo, Yifeng Liu, Adam Maciejewski, David Arndt, Michael Wilson, Vanessa Neveu, \ldots{} David S Wishart} \emph{Nucleic Acids Research} (2013-11-06) \url{https://doi.org/f3mn6d}
\CSLBlock{DOI: \href{https://doi.org/10.1093/nar/gkt1068}{10.1093/nar/gkt1068} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24203711}{24203711} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3965102}{PMC3965102}}}
...
\CSLLeftMargin{54. }%
\CSLRightInline{\textbf{Dhimmel/Lincs V2.0: Refined Consensus Signatures From Lincs L1000}
\CSLBlock{Daniel Himmelstein, Leo Brueggeman, Sergio Baranzini} \emph{Zenodo} (2016-03-08) \url{https://doi.org/f3mqvr}
\CSLBlock{DOI: \href{https://doi.org/10.5281/zenodo.47223}{10.5281/zenodo.47223}}}
...
\CSLLeftMargin{58. }%
\CSLRightInline{\textbf{Niacin in patients with low HDL cholesterol levels receiving intensive statin therapy.}
\CSLBlock{, William E Boden, Jeffrey L Probstfield, Todd Anderson, Bernard R Chaitman, Patrice Desvignes-Nickens, Kent Koprowicz, Ruth McBride, Koon Teo, William Weintraub} \emph{The New England journal of medicine} (2011-11-15) \url{https://www.ncbi.nlm.nih.gov/pubmed/22085343}
\CSLBlock{DOI: \href{https://doi.org/10.1056/nejmoa1107579}{10.1056/nejmoa1107579} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/22085343}{22085343}}}

\leavevmode\vadjust pre{\hypertarget{ref-13ZGxHjQ5}{}}%
\CSLLeftMargin{59. }%
\CSLRightInline{\textbf{Effects of extended-release niacin with laropiprant in high-risk patients.}
\CSLBlock{, Martin J Landray, Richard Haynes, Jemma C Hopewell, Sarah Parish, Theingi Aung, Joseph Tomson, Karl Wallendszus, Martin Craig, Lixin Jiang, \ldots{} Jane Armitage} \emph{The New England journal of medicine} (2014-07-17) \url{https://www.ncbi.nlm.nih.gov/pubmed/25014686}
\CSLBlock{DOI: \href{https://doi.org/10.1056/nejmoa1300955}{10.1056/nejmoa1300955} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25014686}{25014686}}}

\leavevmode\vadjust pre{\hypertarget{ref-ZGvG75Bj}{}}%
\CSLLeftMargin{60. }%
\CSLRightInline{\textbf{Assessment of the Role of Niacin in Managing Cardiovascular Disease Outcomes: A Systematic Review and Meta-analysis.}
\CSLBlock{Elvira D\textquotesingle Andrea, Spencer P Hey, Cherie L Ramirez, Aaron S Kesselheim} \emph{JAMA network open} (2019-04-05) \url{https://www.ncbi.nlm.nih.gov/pubmed/30977858}
\CSLBlock{DOI: \href{https://doi.org/10.1001/jamanetworkopen.2019.2224}{10.1001/jamanetworkopen.2019.2224} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/30977858}{30977858} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6481429}{PMC6481429}}}
...
\CSLLeftMargin{62. }%
\CSLRightInline{\textbf{Niacin: an old lipid drug in a new NAD+ dress}
\CSLBlock{Mario Romani, Dina Carina Hofer, Elena Katsyuba, Johan Auwerx} \emph{Journal of Lipid Research} (2019-04) \url{https://doi.org/gjpjft}
\CSLBlock{DOI: \href{https://doi.org/10.1194/jlr.s092007}{10.1194/jlr.s092007} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/30782960}{30782960} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6446705}{PMC6446705}}}

\leavevmode\vadjust pre{\hypertarget{ref-OOAkmacQ}{}}%
\CSLLeftMargin{63. }%
\CSLRightInline{\textbf{The therapeutic role of niacin in dyslipidemia management.}
\CSLBlock{William E Boden, Mandeep S Sidhu, Peter P Toth} \emph{Journal of cardiovascular pharmacology and therapeutics} (2013-12-20) \url{https://www.ncbi.nlm.nih.gov/pubmed/24363242}
\CSLBlock{DOI: \href{https://doi.org/10.1177/1074248413514481}{10.1177/1074248413514481} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24363242}{24363242}}}

\leavevmode\vadjust pre{\hypertarget{ref-13meq3Hgt}{}}%
\CSLLeftMargin{64. }%
\CSLRightInline{\textbf{High-density lipoproteins in the prevention of cardiovascular disease: changing the paradigm.}
\CSLBlock{S Tuteja, DJ Rader} \emph{Clinical pharmacology and therapeutics} (2014-04-08) \url{https://www.ncbi.nlm.nih.gov/pubmed/24713591}
\CSLBlock{DOI: \href{https://doi.org/10.1038/clpt.2014.79}{10.1038/clpt.2014.79} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24713591}{24713591}}}

\leavevmode\vadjust pre{\hypertarget{ref-izbPw2kc}{}}%
\CSLLeftMargin{65. }%
\CSLRightInline{\textbf{The nicotinic acid receptor GPR109A (HM74A or PUMA-G) as a new therapeutic target}
\CSLBlock{S OFFERMANNS} \emph{Trends in Pharmacological Sciences} (2006-07) \url{https://doi.org/fgb4tr}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.tips.2006.05.008}{10.1016/j.tips.2006.05.008} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/16766048}{16766048}}}

\leavevmode\vadjust pre{\hypertarget{ref-wI0IjT3i}{}}%
\CSLLeftMargin{66. }%
\CSLRightInline{\textbf{Langerhans Cells Release Prostaglandin D2 in Response to Nicotinic Acid}
\CSLBlock{Dominique Maciejewski-Lenoir, Jeremy G Richman, Yaron Hakak, Ibragim Gaidarov, Dominic P Behan, Daniel T Connolly} \emph{Journal of Investigative Dermatology} (2006-12) \url{https://doi.org/dgxg75}
\CSLBlock{DOI: \href{https://doi.org/10.1038/sj.jid.5700586}{10.1038/sj.jid.5700586} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/17008871}{17008871}}}

\leavevmode\vadjust pre{\hypertarget{ref-1Bz0jRHYo}{}}%
\CSLLeftMargin{67. }%
\CSLRightInline{\textbf{Nicotinic acid inhibits progression of atherosclerosis in mice through its receptor GPR109A expressed by immune cells}
\CSLBlock{Martina Lukasova, Camille Malaval, Andreas Gille, Jukka Kero, Stefan Offermanns} \emph{Journal of Clinical Investigation} (2011-03-01) \url{https://doi.org/cqftcq}
\CSLBlock{DOI: \href{https://doi.org/10.1172/jci41651}{10.1172/jci41651} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/21317532}{21317532} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3048854}{PMC3048854}}}

\leavevmode\vadjust pre{\hypertarget{ref-1DblG8swn}{}}%
\CSLLeftMargin{68. }%
\CSLRightInline{\textbf{Role of HDL, ABCA1, and ABCG1 Transporters in Cholesterol Efflux and Immune Responses}
\CSLBlock{Laurent Yvan-Charvet, Nan Wang, Alan R Tall} \emph{Arteriosclerosis, Thrombosis, and Vascular Biology} (2010-02) \url{https://doi.org/ds23w6}
\CSLBlock{DOI: \href{https://doi.org/10.1161/atvbaha.108.179283}{10.1161/atvbaha.108.179283} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/19797709}{19797709} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2812788}{PMC2812788}}}

\leavevmode\vadjust pre{\hypertarget{ref-RliFvowC}{}}%
\CSLLeftMargin{69. }%
\CSLRightInline{\textbf{Shared and organism-specific host responses to childhood diarrheal diseases revealed by whole blood transcript profiling}
\CSLBlock{Hannah A DeBerg, Mussaret B Zaidi, Matthew C Altman, Prasong Khaenam, Vivian H Gersuk, Freddy D Campos, Iza Perez-Martinez, Mario Meza-Segura, Damien Chaussabel, Jacques Banchereau, \ldots{} Peter S Linsley} \emph{PLOS ONE} (2018-01-29) \url{https://doi.org/gcwgcr}
\CSLBlock{DOI: \href{https://doi.org/10.1371/journal.pone.0192082}{10.1371/journal.pone.0192082} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29377961}{29377961} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5788382}{PMC5788382}}}

\leavevmode\vadjust pre{\hypertarget{ref-D5XBhzim}{}}%
\CSLLeftMargin{70. }%
\CSLRightInline{\textbf{Copy Number Loss of the Interferon Gene Cluster in Melanomas Is Linked to Reduced T Cell Infiltrate and Poor Patient Prognosis}
\CSLBlock{Peter S Linsley, Cate Speake, Elizabeth Whalen, Damien Chaussabel} \emph{PLoS ONE} (2014-10-14) \url{https://doi.org/gk9k8s}
\CSLBlock{DOI: \href{https://doi.org/10.1371/journal.pone.0109760}{10.1371/journal.pone.0109760} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25314013}{25314013} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4196925}{PMC4196925}}}

\leavevmode\vadjust pre{\hypertarget{ref-EnoqU4ga}{}}%
\CSLLeftMargin{71. }%
\CSLRightInline{\textbf{The Ro60 autoantigen binds endogenous retroelements and regulates inflammatory gene expression}
\CSLBlock{T Hung, GA Pratt, B Sundararaman, MJ Townsend, C Chaivorapol, T Bhangale, RR Graham, W Ortmann, LA Criswell, GW Yeo, TW Behrens} \emph{Science} (2015-10-23) \url{https://doi.org/f7vs67}
\CSLBlock{DOI: \href{https://doi.org/10.1126/science.aac7442}{10.1126/science.aac7442} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/26382853}{26382853} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4691329}{PMC4691329}}}

\leavevmode\vadjust pre{\hypertarget{ref-11eausmiy}{}}%
\CSLLeftMargin{72. }%
\CSLRightInline{\textbf{Homo sapiens (ID 258384) - BioProject - NCBI} \url{https://www.ncbi.nlm.nih.gov/bioproject/PRJNA258384}}

\leavevmode\vadjust pre{\hypertarget{ref-mtMYROCN}{}}%
\CSLLeftMargin{73. }%
\CSLRightInline{\textbf{Identification of Genes Critical for Resistance to Infection by West Nile Virus Using RNA-Seq Analysis}
\CSLBlock{Feng Qian, Lisa Chung, Wei Zheng, Vincent Bruno, Roger Alexander, Zhong Wang, Xiaomei Wang, Sebastian Kurscheid, Hongyu Zhao, Erol Fikrig, \ldots{} Ruth Montgomery} \emph{Viruses} (2013-07-08) \url{https://doi.org/f49d7g}
\CSLBlock{DOI: \href{https://doi.org/10.3390/v5071664}{10.3390/v5071664} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/23881275}{23881275} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3738954}{PMC3738954}}}

\leavevmode\vadjust pre{\hypertarget{ref-1kgcHkGm}{}}%
\CSLLeftMargin{74. }%
\CSLRightInline{\textbf{Mycobacterial infection induces a specific human innate immune response}
\CSLBlock{John D Blischak, Ludovic Tailleux, Amy Mitrano, Luis B Barreiro, Yoav Gilad} \emph{Scientific Reports} (2015-11-20) \url{https://doi.org/f7zk5c}
\CSLBlock{DOI: \href{https://doi.org/10.1038/srep16882}{10.1038/srep16882} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/26586179}{26586179} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4653619}{PMC4653619}}}

\leavevmode\vadjust pre{\hypertarget{ref-kLRErKXz}{}}%
\CSLLeftMargin{75. }%
\CSLRightInline{\textbf{Niacin Inhibits Apoptosis and Rescues Premature Ovarian Failure}
\CSLBlock{Shufang Wang, Min Sun, Ling Yu, Yixuan Wang, Yuanqing Yao, Deqing Wang} \emph{Cellular Physiology and Biochemistry} (2018) \url{https://doi.org/gfqvcq}
\CSLBlock{DOI: \href{https://doi.org/10.1159/000495051}{10.1159/000495051} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/30415247}{30415247}}}

\leavevmode\vadjust pre{\hypertarget{ref-TovvsrDr}{}}%
\CSLLeftMargin{76. }%
\CSLRightInline{\textbf{Chronic niacin administration ameliorates ovulation, histological changes in the ovary and adiponectin concentrations in a rat model of polycystic ovary syndrome}
\CSLBlock{Negin Asadi, Mahin Izadi, Ali Aflatounian, Mansour Esmaeili-Dehaj, Mohammad Ebrahim Rezvani, Zeinab Hafizi} \emph{Reproduction, Fertility and Development} (2021) \url{https://doi.org/gjpjkt}
\CSLBlock{DOI: \href{https://doi.org/10.1071/rd20306}{10.1071/rd20306} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/33751926}{33751926}}}

\leavevmode\vadjust pre{\hypertarget{ref-14dCeRkua}{}}%
\CSLLeftMargin{77. }%
\CSLRightInline{\textbf{Avoiding common pitfalls when clustering biological data}
\CSLBlock{Tom Ronan, Zhijie Qi, Kristen M Naegle} \emph{Science Signaling} (2016-06-14) \url{https://doi.org/gcvjr6}
\CSLBlock{DOI: \href{https://doi.org/10.1126/scisignal.aad1932}{10.1126/scisignal.aad1932} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/27303057}{27303057}}}

\leavevmode\vadjust pre{\hypertarget{ref-uw3AnEgA}{}}%
\CSLLeftMargin{78. }%
\CSLRightInline{\textbf{Cluster Ensembles -- A Knowledge Reuse Framework for Combining Multiple Partitions}
\CSLBlock{Alexander Strehl, Ghosh Joydeep} \emph{Journal of Machine Learning Research} (2002) \url{https://www.jmlr.org/papers/v3/strehl02a.html}}

\leavevmode\vadjust pre{\hypertarget{ref-cuROQDFa}{}}%
\CSLLeftMargin{79. }%
\CSLRightInline{\textbf{Combining multiple clusterings using evidence accumulation}
\CSLBlock{Ana LN Fred, Anil K Jain} \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence} (2005-06) \url{https://doi.org/bsknv6}
\CSLBlock{DOI: \href{https://doi.org/10.1109/tpami.2005.113}{10.1109/tpami.2005.113} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/15943417}{15943417}}}

\leavevmode\vadjust pre{\hypertarget{ref-xhtEAzx6}{}}%
\CSLLeftMargin{80. }%
\CSLRightInline{\textbf{Clustering trees: a visualization for evaluating clusterings at multiple resolutions}
\CSLBlock{Luke Zappia, Alicia Oshlack} \emph{GigaScience} (2018-07-01) \url{https://doi.org/gfzqf5}
\CSLBlock{DOI: \href{https://doi.org/10.1093/gigascience/giy083}{10.1093/gigascience/giy083} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/30010766}{30010766} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6057528}{PMC6057528}}}
...
\CSLBlock{Darryl P Leong, Koon K Teo, Sumathy Rangarajan, Patricio Lopez-Jaramillo, Alvaro Avezum, Andres Orlandini, Pamela Seron, Suad H Ahmed, Annika Rosengren, Roya Kelishadi, \ldots{} } \emph{Lancet (London, England)} (2015-05-13) \url{https://www.ncbi.nlm.nih.gov/pubmed/25982160}
...
\CSLLeftMargin{82. }%
\CSLRightInline{\textbf{Densely Interconnected Transcriptional Circuits Control Cell States in Human Hematopoiesis}
\CSLBlock{Noa Novershtern, Aravind Subramanian, Lee N Lawton, Raymond H Mak, WNicholas Haining, Marie E McConkey, Naomi Habib, Nir Yosef, Cindy Y Chang, Tal Shay, \ldots{} Benjamin L Ebert} \emph{Cell} (2011-01) \url{https://doi.org/cf5k92}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.cell.2011.01.004}{10.1016/j.cell.2011.01.004} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/21241896}{21241896} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3049864}{PMC3049864}}}

\leavevmode\vadjust pre{\hypertarget{ref-10qjLoufR}{}}%
\CSLLeftMargin{83. }%
\CSLRightInline{\textbf{Depression as a predictor for coronary heart disease. a review and meta-analysis.}
\CSLBlock{Reiner Rugulies} \emph{American journal of preventive medicine} (2002-07) \url{https://www.ncbi.nlm.nih.gov/pubmed/12093424}
\CSLBlock{DOI: \href{https://doi.org/10.1016/s0749-3797(02)00439-7}{10.1016/s0749-3797(02)00439-7} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/12093424}{12093424}}}

\leavevmode\vadjust pre{\hypertarget{ref-j2Sl4DAE}{}}%
\CSLLeftMargin{84. }%
\CSLRightInline{\textbf{Mental Disorders Across the Adult Life Course and Future Coronary Heart Disease}
\CSLBlock{Catharine R Gale, GDavid Batty, David PJ Osborn, Per Tynelius, Finn Rasmussen} \emph{Circulation} (2014-01-14) \url{https://doi.org/qm4}
\CSLBlock{DOI: \href{https://doi.org/10.1161/circulationaha.113.002065}{10.1161/circulationaha.113.002065} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/24190959}{24190959} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4107269}{PMC4107269}}}

\leavevmode\vadjust pre{\hypertarget{ref-17LYMnG9n}{}}%
\CSLLeftMargin{85. }%
\CSLRightInline{\textbf{Mortality gap for people with bipolar disorder and schizophrenia: UK-based cohort study 2000--2014}
\CSLBlock{Joseph F Hayes, Louise Marston, Kate Walters, Michael B King, David PJ Osborn} \emph{British Journal of Psychiatry} (2017-09) \url{https://doi.org/gbwcjx}
\CSLBlock{DOI: \href{https://doi.org/10.1192/bjp.bp.117.202606}{10.1192/bjp.bp.117.202606} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/28684403}{28684403} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5579328}{PMC5579328}}}

\leavevmode\vadjust pre{\hypertarget{ref-13t4TuFeJ}{}}%
\CSLLeftMargin{86. }%
\CSLRightInline{\textbf{Getting to the Heart of Alzheimer Disease}
\CSLBlock{Joshua M Tublin, Jeremy M Adelstein, Federica del Monte, Colin K Combs, Loren E Wold} \emph{Circulation Research} (2019-01-04) \url{https://doi.org/gjzjgq}
\CSLBlock{DOI: \href{https://doi.org/10.1161/circresaha.118.313563}{10.1161/circresaha.118.313563} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/30605407}{30605407} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6319653}{PMC6319653}}}

\leavevmode\vadjust pre{\hypertarget{ref-D83Aqhga}{}}%
\CSLLeftMargin{87. }%
\CSLRightInline{\textbf{The overlap between vascular disease and Alzheimer's disease - lessons from pathology}
\CSLBlock{Johannes Attems, Kurt A Jellinger} \emph{BMC Medicine} (2014-11-11) \url{https://doi.org/f6pjd4}
\CSLBlock{DOI: \href{https://doi.org/10.1186/s12916-014-0206-2}{10.1186/s12916-014-0206-2} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/25385447}{25385447} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4226890}{PMC4226890}}}

\leavevmode\vadjust pre{\hypertarget{ref-9BGyO071}{}}%
\CSLLeftMargin{88. }%
\CSLRightInline{\textbf{Cardiovascular Risk Factors for Alzheimer\textquotesingle s Disease}
\CSLBlock{Clive Rosendorff, Michal S Beeri, Jeremy M Silverman} \emph{The American Journal of Geriatric Cardiology} (2007-03) \url{https://doi.org/bpfw5d}
\CSLBlock{DOI: \href{https://doi.org/10.1111/j.1076-7460.2007.06696.x}{10.1111/j.1076-7460.2007.06696.x} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/17483665}{17483665}}}

\leavevmode\vadjust pre{\hypertarget{ref-idlBgtFz}{}}%
\CSLLeftMargin{89. }%
\CSLRightInline{\textbf{Reverse cholesterol transport and cholesterol efflux in atherosclerosis}
\CSLBlock{R Ohashi, H Mu, X Wang, Q Yao, C Chen} \emph{QJM: An International Journal of Medicine} (2005-10-28) \url{https://doi.org/dn2fgt}
\CSLBlock{DOI: \href{https://doi.org/10.1093/qjmed/hci136}{10.1093/qjmed/hci136} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/16258026}{16258026}}}

\leavevmode\vadjust pre{\hypertarget{ref-18I4ish9s}{}}%
\CSLLeftMargin{90. }%
\CSLRightInline{\textbf{Lipid and Lipoprotein Metabolism in Microglia}
\CSLBlock{Bailey A Loving, Kimberley D Bruce} \emph{Frontiers in Physiology} (2020-04-28) \url{https://doi.org/gk92xd}
\CSLBlock{DOI: \href{https://doi.org/10.3389/fphys.2020.00393}{10.3389/fphys.2020.00393} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32411016}{32411016} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7198855}{PMC7198855}}}

\leavevmode\vadjust pre{\hypertarget{ref-LyJmyoQr}{}}%
\CSLLeftMargin{91. }%
\CSLRightInline{\textbf{Shared genetic origin of asthma, hay fever and eczema elucidates allergic disease biology}
\CSLBlock{Manuel A Ferreira, Judith M Vonk, Hansjörg Baurecht, Ingo Marenholz, Chao Tian, Joshua D Hoffman, Quinta Helmer, Annika Tillander, Vilhelmina Ullemar, \ldots{} } \emph{Nature Genetics} (2017-10-30) \url{https://doi.org/gchg62}
\CSLBlock{DOI: \href{https://doi.org/10.1038/ng.3985}{10.1038/ng.3985} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29083406}{29083406} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5989923}{PMC5989923}}}

\leavevmode\vadjust pre{\hypertarget{ref-veADXImD}{}}%
\CSLLeftMargin{92. }%
\CSLRightInline{\textbf{A genome-wide cross-trait analysis from UK Biobank highlights the shared genetic architecture of asthma and allergic diseases}
\CSLBlock{Zhaozhong Zhu, Phil H Lee, Mark D Chaffin, Wonil Chung, Po-Ru Loh, Quan Lu, David C Christiani, Liming Liang} \emph{Nature Genetics} (2018-05-21) \url{https://doi.org/gdpmtn}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41588-018-0121-0}{10.1038/s41588-018-0121-0} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29785011}{29785011} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5980765}{PMC5980765}}}

\leavevmode\vadjust pre{\hypertarget{ref-TPVeG4GP}{}}%
\CSLLeftMargin{93. }%
\CSLRightInline{\textbf{recount3: summaries and queries for large-scale RNA-seq expression and splicing}
\CSLBlock{Christopher Wilks, Shijie C Zheng, Feng Yong Chen, Rone Charles, Brad Solomon, Jonathan P Ling, Eddie Luidy Imada, David Zhang, Lance Joseph, Jeffrey T Leek, \ldots{} Ben Langmead} \emph{Cold Spring Harbor Laboratory} (2021-05-23) \url{https://doi.org/gj7cmq}
\CSLBlock{DOI: \href{https://doi.org/10.1101/2021.05.21.445138}{10.1101/2021.05.21.445138}}}
...
\CSLLeftMargin{96. }%
\CSLRightInline{\textbf{Probabilistic colocalization of genetic variants from complex and molecular traits: promise and limitations}
\CSLBlock{Abhay Hukku, Milton Pividori, Francesca Luca, Roger Pique-Regi, Hae Kyung Im, Xiaoquan Wen} \emph{The American Journal of Human Genetics} (2021-01) \url{https://doi.org/gj58gg}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.ajhg.2020.11.012}{10.1016/j.ajhg.2020.11.012} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/33308443}{33308443} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7820626}{PMC7820626}}}

\leavevmode\vadjust pre{\hypertarget{ref-AxVJwanp}{}}%
\CSLLeftMargin{97. }%
\CSLRightInline{\textbf{Transcriptome-wide association study of schizophrenia and chromatin activity yields mechanistic disease insights}
\CSLBlock{Alexander Gusev, Nicholas Mancuso, Hyejung Won, Maria Kousi, Hilary K Finucane, Yakir Reshef, Lingyun Song, Alexias Safi, Steven McCarroll, Benjamin M Neale, \ldots{} } \emph{Nature Genetics} (2018-04) \url{https://doi.org/gdfdf2}
\CSLBlock{DOI: \href{https://doi.org/10.1038/s41588-018-0092-1}{10.1038/s41588-018-0092-1} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29632383}{29632383} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5942893}{PMC5942893}}}

\leavevmode\vadjust pre{\hypertarget{ref-fnDaLjFy}{}}%
\CSLLeftMargin{98. }%
\CSLRightInline{\textbf{Systematic tissue annotations of --omics samples by modeling unstructured metadata}
\CSLBlock{Nathaniel T Hawkins, Marc Maldaver, Anna Yannakopoulos, Lindsay A Guare, Arjun Krishnan} \emph{Cold Spring Harbor Laboratory} (2021-05-11) \url{https://doi.org/gj2pkc}
\CSLBlock{DOI: \href{https://doi.org/10.1101/2021.05.10.443525}{10.1101/2021.05.10.443525}}}
...
\CSLBlock{Alvaro N Barbeira, Scott P Dickinson, Rodrigo Bonazzola, Jiamao Zheng, Heather E Wheeler, Jason M Torres, Eric S Torstenson, Kaanan P Shah, Tzintzuni Garcia, \ldots{} Hae Kyung Im} \emph{Nature Communications} (2018-05-08) \url{https://doi.org/gdjvp5}
...
\CSLLeftMargin{100. }%
\CSLRightInline{\textbf{The Molecular Signatures Database Hallmark Gene Set Collection}
\CSLBlock{Arthur Liberzon, Chet Birger, Helga Thorvaldsdóttir, Mahmoud Ghandi, Jill~P Mesirov, Pablo Tamayo} \emph{Cell Systems} (2015-12) \url{https://doi.org/gf78hq}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.cels.2015.12.004}{10.1016/j.cels.2015.12.004} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/26771021}{26771021} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4707969}{PMC4707969}}}
...
\CSLLeftMargin{103. }%
\CSLRightInline{\textbf{Modeling sample variables with an Experimental Factor Ontology}
\CSLBlock{James Malone, Ele Holloway, Tomasz Adamusiak, Misha Kapushesky, Jie Zheng, Nikolay Kolesnikov, Anna Zhukova, Alvis Brazma, Helen Parkinson} \emph{Bioinformatics} (2010-03-03) \url{https://doi.org/dsb6vt}
\CSLBlock{DOI: \href{https://doi.org/10.1093/bioinformatics/btq099}{10.1093/bioinformatics/btq099} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/20200009}{20200009} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2853691}{PMC2853691}}}

\leavevmode\vadjust pre{\hypertarget{ref-16RTdMKxI}{}}%
\CSLLeftMargin{104. }%
\CSLRightInline{\textbf{Mapping UK Biobank to the Experimental Factor Ontology (EFO)}
\CSLBlock{EBISPOT} (2022-05-03) \url{https://github.com/EBISPOT/EFO-UKB-mappings}}

\leavevmode\vadjust pre{\hypertarget{ref-e4AuoW8N}{}}%
\CSLLeftMargin{105. }%
\CSLRightInline{\textbf{Comparing partitions}
\CSLBlock{Lawrence Hubert, Phipps Arabie} \emph{Journal of Classification} (1985-12) \url{https://doi.org/bphmzh}
\CSLBlock{DOI: \href{https://doi.org/10.1007/bf01908075}{10.1007/bf01908075}}}

\leavevmode\vadjust pre{\hypertarget{ref-8js8Q3pF}{}}%
\CSLLeftMargin{106. }%
\CSLRightInline{\textbf{Diversity control for improving the analysis of consensus clustering}
\CSLBlock{Milton Pividori, Georgina Stegmayer, Diego H Milone} \emph{Information Sciences} (2016-09) \url{https://doi.org/ghtqbk}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.ins.2016.04.027}{10.1016/j.ins.2016.04.027}}}

\leavevmode\vadjust pre{\hypertarget{ref-rcTMvL18}{}}%
\CSLLeftMargin{107. }%
\CSLRightInline{\textbf{A Link-Based Approach to the Cluster Ensemble Problem}
\CSLBlock{Natthakan Iam-On, Tossapon Boongoen, Simon Garrett, Chris Price} \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence} (2011-12) \url{https://doi.org/cqgkh3}
\CSLBlock{DOI: \href{https://doi.org/10.1109/tpami.2011.84}{10.1109/tpami.2011.84} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/21576752}{21576752}}}

\leavevmode\vadjust pre{\hypertarget{ref-t5p3UpxZ}{}}%
\CSLLeftMargin{108. }%
\CSLRightInline{\textbf{Hybrid clustering solution selection strategy}
\CSLBlock{Zhiwen Yu, Le Li, Yunjun Gao, Jane You, Jiming Liu, Hau-San Wong, Guoqiang Han} \emph{Pattern Recognition} (2014-10) \url{https://doi.org/ghtzwt}
\CSLBlock{DOI: \href{https://doi.org/10.1016/j.patcog.2014.04.005}{10.1016/j.patcog.2014.04.005}}}

\leavevmode\vadjust pre{\hypertarget{ref-157h5hA34}{}}%
\CSLLeftMargin{109. }%
\CSLRightInline{\textbf{UMAP: Uniform Manifold Approximation and Projection for Dimension Reduction}
\CSLBlock{Leland McInnes, John Healy, James Melville} \emph{arXiv} (2020-09-21) \url{https://arxiv.org/abs/1802.03426}}

\leavevmode\vadjust pre{\hypertarget{ref-MxGpAiPu}{}}%
\CSLLeftMargin{110. }%
\CSLRightInline{\textbf{k-means++: the advantages of careful seeding}
\CSLBlock{David Arthur, Sergei Vassilvitskii} \emph{Proceedings of the Eighteenth Annual ACM-SIAM Symposium on Discrete Algorithms} (2007) \url{http://ilpubs.stanford.edu:8090/778/1/2006-13.pdf}}

\leavevmode\vadjust pre{\hypertarget{ref-x3CT24TB}{}}%
\CSLLeftMargin{111. }%
\CSLRightInline{\textbf{On Spectral Clustering: Analysis and an algorithm}
\CSLBlock{Andrew Ng, Michael Jordan, Yair Weiss} \emph{Advances in Neural Information Processing Systems} (2001) \url{https://ai.stanford.edu/~ang/papers/nips01-spectral.pdf}}

\leavevmode\vadjust pre{\hypertarget{ref-JrL3iQea}{}}%
\CSLLeftMargin{112. }%
\CSLRightInline{\textbf{A Density-Based Algorithm for Discovering Clusters in Large Spatial Databases with Noise}
\CSLBlock{Martin Ester, Hans-Peter Kriegel, Jörg Sander, Xiaowei Xu} \emph{Proceedings of the Second International Conference on Knowledge Discovery and Data Mining} (1996) \url{https://www.aaai.org/Papers/KDD/1996/KDD96-037.pdf}}

\leavevmode\vadjust pre{\hypertarget{ref-FB7XPWl6}{}}%
\CSLLeftMargin{113. }%
\CSLRightInline{\textbf{Determination of Optimal Epsilon (Eps) Value on DBSCAN Algorithm to Clustering Data on Peatland Hotspots in Sumatra}
\CSLBlock{Nadia Rahmah, Imas Sukaesih Sitanggang} \emph{IOP Conference Series: Earth and Environmental Science} (2016-01) \url{https://doi.org/gqr7z2}
\CSLBlock{DOI: \href{https://doi.org/10.1088/1755-1315/31/1/012012}{10.1088/1755-1315/31/1/012012}}}

\leavevmode\vadjust pre{\hypertarget{ref-S7LBsfcF}{}}%
\CSLLeftMargin{114. }%
\CSLRightInline{\textbf{Avoiding common pitfalls when clustering biological data.}
\CSLBlock{Tom Ronan, Zhijie Qi, Kristen M Naegle} \emph{Science signaling} (2016-06-14) \url{https://www.ncbi.nlm.nih.gov/pubmed/27303057}
\CSLBlock{DOI: \href{https://doi.org/10.1126/scisignal.aad1932}{10.1126/scisignal.aad1932} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/27303057}{27303057}}}

\leavevmode\vadjust pre{\hypertarget{ref-vNXTnmxp}{}}%
\CSLLeftMargin{115. }%
\CSLRightInline{\textbf{Optimized sgRNA design to maximize activity and minimize off-target effects of CRISPR-Cas9.}
\CSLBlock{John G Doench, Nicolo Fusi, Meagan Sullender, Mudra Hegde, Emma W Vaimberg, Katherine F Donovan, Ian Smith, Zuzana Tothova, Craig Wilen, Robert Orchard, \ldots{} David E Root} \emph{Nature biotechnology} (2016-01-18) \url{https://www.ncbi.nlm.nih.gov/pubmed/26780180}
\CSLBlock{DOI: \href{https://doi.org/10.1038/nbt.3437}{10.1038/nbt.3437} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/26780180}{26780180} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4744125}{PMC4744125}}}

\leavevmode\vadjust pre{\hypertarget{ref-SiobXsoB}{}}%
\CSLLeftMargin{116. }%
\CSLRightInline{\textbf{Fine‐mapping and QTL tissue‐sharing information improves the reliability of causal gene identification}
\CSLBlock{Alvaro N Barbeira, Owen J Melia, Yanyu Liang, Rodrigo Bonazzola, Gao Wang, Heather E Wheeler, François Aguet, Kristin G Ardlie, Xiaoquan Wen, Hae K Im} \emph{Genetic Epidemiology} (2020-09-10) \url{https://doi.org/gqsvf7}
\CSLBlock{DOI: \href{https://doi.org/10.1002/gepi.22346}{10.1002/gepi.22346} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32964524}{32964524} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7693040}{PMC7693040}}}

\leavevmode\vadjust pre{\hypertarget{ref-GPHGnFRN}{}}%
\CSLLeftMargin{117. }%
\CSLRightInline{\textbf{Harmonization and Imputation Overview}
\CSLBlock{hakyimlab} (2022-10-31) \url{https://github.com/hakyimlab/summary-gwas-imputation}}

\leavevmode\vadjust pre{\hypertarget{ref-VKYS05n1}{}}%
\CSLLeftMargin{118. }%
\CSLRightInline{\textbf{Homo sapiens (ID 232177) - BioProject - NCBI} \url{https://www.ncbi.nlm.nih.gov/bioproject/PRJNA232177}}
...
\hypertarget{regression-model-for-lv-trait-associations}{%
\subsubsection{Regression model for LV-trait associations}\label{regression-model-for-lv-trait-associations}}

\hypertarget{sm:reg:null_sim}{%
\paragraph{Supplementary Note 1: mean type I error rates and calibration of LV-based regression model}\label{sm:reg:null_sim}}
...
2) different GWAS processing steps, including harmonization and imputation procedures as defined in {[}\protect\hyperlink{ref-SiobXsoB}{116}{]},
...
The scripts to run these steps are available in {[}\protect\hyperlink{ref-GPHGnFRN}{117}{]}.
...
Figure \ref{fig:reg:nulls:qqplots} compares the distribution of \(p\)-values of the OLS and GLS models.
...
Importantly, the GLS model is able to correct for LVs with adjacent and highly correlated genes at the top such as LV234 (Figure \ref{fig:reg:nulls:qqplot:lv234}), LV847 (Figure \ref{fig:reg:nulls:qqplot:lv847}), LV45 (Figure \ref{fig:reg:nulls:qqplot:lv45}), or LV800 (Figure \ref{fig:reg:nulls:qqplot:lv800}), among others.
...
One example is LV914, shown in Figure \ref{fig:reg:nulls:qqplot:lv914}.
...
\hypertarget{lv-trait-associations-in-real-data}{%
\paragraph{LV-trait associations in real data}\label{lv-trait-associations-in-real-data}}
...
\hypertarget{screening-steps}{%
\paragraph{Screening steps}\label{screening-steps}}
...
\caption{}\label{fig:sup:crispr:table1}
}
\end{figure}
...
\paragraph{Gene modules enrichment for lipids gene-sets}\label{gene-modules-enrichment-for-lipids-gene-sets}}

\begin{longtable}[]{@{}llll@{}}
\caption{Gene modules (LVs) nominally enriched for the lipids-increasing gene-set from the CRISPR-screen (\emph{P} \textless{} 0.01). LVs significantly aligned with pathways (FDR \textless{} 0.05) from the MultiPLIER models are shown in boldface.
...
\begin{longtable}[]{@{}llll@{}}
\caption{Gene modules (LVs) nominally enriched for the lipids-decreasing gene-set from the CRISPR-screen (\emph{P} \textless{} 0.01). LVs significantly aligned with pathways (FDR \textless{} 0.05) from the MultiPLIER models are shown in boldface.
...
\hypertarget{consensus-clustering-of-traits}{%
\subsubsection{Consensus clustering of traits}\label{consensus-clustering-of-traits}}

\hypertarget{sm:clustering:null_sim}{%
\paragraph{Supplementary Note 2: Cluster analyses under the null hypothesis of no structure in the data}\label{sm:clustering:null_sim}}
...
The results of this analysis (Figure \ref{fig:sup:clustering:agreement}) show that, under the two simulated null scenarios, the agreement of the consensus partitions with the ensemble is very close to zero.
...
\paragraph{Cluster-specific and general transcriptional processes associated with disease}\label{cluster-specific-and-general-transcriptional-processes-associated-with-disease}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.6970}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.7561}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0915}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0549}}
...
Pulmonary microvascular endothelial cells were exposed to hypoxia for 24 hours or more {[}\protect\hyperlink{ref-VKYS05n1}{118}{]};}\label{fig:sup:lv136}
}
\end{figure}
