...
%SUPPLEMENTARY_INFORMATION_STARTS_HERE%
...
\caption{\textbf{Primers for generating illumina libraries.} Sequences are provided in a readable format in Supplementary Data 8.}\label{fig:sup:crispr:table1}
}
\end{figure}
