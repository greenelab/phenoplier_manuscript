...
<!--  -->
Alzheimer's disease (GWAS $n$=54,162 with 17,008 cases from [@pmid:24162737]), for example, was significantly associated with LV21 (FDR = 1.64e-19) and with LV5 (FDR = 3.06e-03) (Supplementary Tables @tbl:sup:lv21 and @tbl:sup:lv5).
...
<!--  -->
ADHD ($n$=53,293 with 19,099 cases from [@doi:10.1038/s41588-018-0269-7]) was the only significantly associated trait for LV434 (FDR < 0.01), which was expressed in glioma cells, cerebral organoids, and several different cell populations from the brain: fetal neurons (replicating and quiescence), microglia, and astrocytes (Supplementary Figure @fig:sup:lv434).
<!-- 
