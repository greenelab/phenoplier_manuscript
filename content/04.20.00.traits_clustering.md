...
For example, modules such as LV928 and LV30 (Supplementary Figures @fig:sup:lv928 and @fig:sup:lv30), which are known to be related to early progenitors of the erythrocytes lineage [@doi:10.1016/j.cell.2011.01.004], are predominantly expressed in early differentiation stages of erythropoiesis, and strongly associated with different assays on red blood cells (erythrocytes and reticulocytes, including cell counts, mean volumes and distribution width) (`Add p-values`{.red}).
On the other side, others are highly specific, such as LV730, expressed in thrombocytes from different cancer samples (Supplementary Figures @fig:sup:lv730), and exclusively associated with hemathological assays on platelets;
or LV598, whose genes are expressed in corneal endothelial cells (Supplementary Figures @fig:sup:lv598) and exclusively associated to keratometry measurements (FDR < 0.05; Supplementary Table @tbl:sup:phenomexcan_assocs:lv598).
<!-- 
...
(`Add LV p-values for hypertension and other cardiovascular traits first`{.red})

The autommune diseases sub-branch also has significant gene modules associations expressed in highly relevant cell types.
LV844 was the most strongly associated gene module with autoimmune disorders (Supplementary Tables @tbl:sup:phenomexcan_assocs:lv844 and @tbl:sup:emerge_assocs:lv844), and was expressed in blood samples, breast organoids, myeloma cells, lung fibroblasts and different cell types from the brain (Supplementary Figures @fig:sup:lv844).
<!--  -->
...
<!--  -->
LV155 was exclusively expressed in thyroid (Supplementary Figures @fig:sup:lv155), and significantly associated with hypothyroidism both in PhenomeXcan and eMERGE (FDR < 0.05; Supplementary Tables @tbl:sup:phenomexcan_assocs:lv598 and @tbl:sup:emerge_assocs:lv155).
...
<!--  -->
Alzheimer's disease (GWAS $n$=54,162 with 17,008 cases from [@pmid:24162737]), for example, was significantly associated with LV21 (FDR = 1.64e-19) and with LV5 (FDR = 3.06e-03) (Supplementary Tables @tbl:sup:phenomexcan_assocs:lv21 and @tbl:sup:phenomexcan_assocs:lv5).
...
LV5 was expressed in brain glioma samples [@doi:10.1126/science.1254257; @doi:10.1186/s13059-015-0684-3], microglia (cortex), liver and kidney, among other cell types (Supplementary Figure @fig:sup:lv5).
LV21 and LV5 were also strongly associated with lipids (GWAS from [@pmid:27005778]): LDL cholesterol ($n$=13,527; FDR < 0.001) and triglycerides ($n$=21,559; FDR < 0.05 and FDR < 0.001, respectively).
Additionally, LV5 was associated with other eight depression traits from the UK Biobank [@doi:10.1038/s41586-018-0579-z], all of them with GWAS sample sizes larger than 100,000.
<!--  -->
ADHD ($n$=53,293 with 19,099 cases from [@doi:10.1038/s41588-018-0269-7]) was the only significantly associated trait for LV434 (FDR < 0.01) (Supplementary Table @tbl:sup:phenomexcan_assocs:lv434), which was expressed in glioma cells, cerebral organoids, and several different cell populations from the brain: fetal neurons (replicating and quiescence), microglia, and astrocytes (Supplementary Figure @fig:sup:lv434).
<!-- 
...
<!--  -->
None of these LVs were aligned to prior pathways.
Thus they might represent potentially novel transcriptional processes affecting the cardiovascular and central nervous system.
...
- We have to include supplementary tables with the entire matrix Z from MultiPLIER, so readers can see which genes belong to LVs/gene modules.
Minor:
