...
Here we introduce PhenoPLIER, a polygenic approach that leverages gene modules (genes with similar expression patterns across the same cell types) to project both gene-trait associations and pharmacological perturbation data into a common latent representation for a joint analysis.
