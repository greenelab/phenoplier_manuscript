...
Despite this information loss and contrary to our expectations, the LV-based method outperformed the gene-based one with an area under the curve of 0.632 and an average precision of 0.858 (Figure @fig:drug_disease:roc_pr).
...
We found this compound was predicted by the gene-based and LV-based approach as a medical indication for coronary artery disease (CAD), with scores above the mean (0.51 and 0.96, respectively).
...
Notably, LV246 (Figure @fig:lv246), expressed in adipose tissue and liver and associated with plasma lipids and hypercholesterolemia (Supplementary Table @tbl:sup:phenomexcan_assocs:lv246), was among the top 25 modules (95th percentile) positively contributing to the prediction of niacin as a therapeutic drug for AT.
Besides the gold standard set, LV246 was also among the top 25 modules for other cardiovascular diseases, such as ischaemic heart disease (a wide definition) and hypercholesterolemia.
...
After projecting the differential expression $z$-scores of niacin into the latent space, this compound on average up-regulates the expression of genes in LV116, whereas it down-regulates those in LV931 and LV246.
Given the current controversy around this compound and its effect on cardiovascular disease, our approach may help to better understand different pathophysiological mechanisms linked with the mechanism of action of drugs.


<!-- niacin:cardiovascular:top_lvs:start -->
| LV    | Cell type             | Niacin effect   | Disease                                      | Sample size   | Cases   |
|:------|:----------------------|:----------------|:---------------------------------------------|:--------------|:--------|
| LV116 | Immune cells          | +               | Atherosclerosis (ICD10 I70)                  | 361,194       | 566     |
|       |                       |                 | Chronic ischaemic heart disease (ICD10 I25)  | 361,194       | 12,769  |
|       |                       |                 | Heart attack, angina, stroke or hypertension | 360,420       | 253,565 |
|       |                       |                 | Ischaemic heart disease (wide definition)    | 361,194       | 20,857  |
| LV931 | Immune cells          | -               | Atherosclerosis (ICD10 I70)                  | 361,194       | 566     |
|       |                       |                 | Heart attack, angina, stroke or hypertension | 360,420       | 253,565 |
|       |                       |                 | Ischaemic heart disease (wide definition)    | 361,194       | 20,857  |
| LV246 | Adipose tissue, liver | -               | Atherosclerosis (ICD10 I70)                  | 361,194       | 566     |
|       |                       |                 | High cholesterol (self-reported)             | 361,141       | 43,957  |
|       |                       |                 | Ischaemic heart disease (wide definition)    | 361,194       | 20,857  |

Table: LVs among the top 20 contributors of prediction of Niacin for some cardiovascular diseases. "Heart attack, angina, stroke or hypertension" refers to the UK Biobank data-field 6150. {#tbl:niacin:cardio:top_lvs}
