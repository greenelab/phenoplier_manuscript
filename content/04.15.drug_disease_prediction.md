...
Notably, LV246 (Figure @fig:lv246), expressed in adipose tissue and liver, and associated with plasma lipids (Supplementary Table @tbl:sup:phenomexcan_assocs:lv246), was among the top 20 modules contributing to the prediction of niacin as a therapeutic drug for AT and other cardiovascular diseases, such as ischaemic heart disease (20,857 cases) and hypercholesterolemia (43,957 cases).
<!--  -->
SHOULD I SHOW A FIGURE HERE?
OR
AT LEAST SHOW HOW MANY LVS POSTIVIELY CONTRIBUTE TO THIS PREDICTION

<!-- As shown before, gene weights of LV246 were predictive of several cardiovascular traits (Supplementary Table @tbl:sup:phenomexcan_assocs:lv246), and several of its top genes were significantly associated and colocalized with cardiovascular-related traits:
...
LV116 and LV931 (Supplementary Figures @fig:sup:lv116 and @fig:sup:lv931) were the top two modules for AT,
and LV116 was among the top niacin contribuors for most of the cardiovascular traits, with a strong signature in monocytes, macrophages and other immune cells, particularly when they were stimulated with a viral infection.
<!--  -->
I NEED A FIGURE OR TABLE HERE
