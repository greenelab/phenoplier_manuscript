...
As explained before, this can be attributed to the limitations in accurately computing a gene correlation matrix and as a result, we have excluded these LVs from our main analyses.
