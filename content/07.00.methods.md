...
`Comments`{.red}
- it has to be clear how we are computing the agreement of the consensus partition with the ensemble, put the formula
- cite here section {#sm:clustering:null_sim}
- mention consensus index approach when selecting the final number of clusters
