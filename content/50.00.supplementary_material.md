...
We then used the $p$-values to identify the most significant GWAS loci and their corresponding trait-associated genes.
...
In both cases, we randomly assign a gene to a group, and then simulate the data with and without the group.
...
The most striking observation is that the consensus partitions are clustered around the gene expression levels of the disease genes.
This suggests that the disease genes are the most important sources of agreement in the consensus partitions.
