...
We show that our gene module-based approach is more robust to identify genetic associations with relevant traits, and that it can be used to contextualize these results by identifing tissue and cell type-specific gene-trait associations.
