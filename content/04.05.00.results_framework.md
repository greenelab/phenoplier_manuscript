...
For TWAS, we used results from PhenomeXcan [@doi:10.1126/sciadv.aba2083] and the eMERGE network as a discovery and replication cohorts, respectively ([Methods](#sec:methods:twas)).
PhenomeXcan provides gene-trait associations for 4,091 different diseases and traits from the UK Biobank [@doi:10.1038/s41586-018-0579-z] and other studies (Table `S999`{.red}), whereas the analyses on eMERGE were performed across 309 phecodes (Table `S999`{.red}).
